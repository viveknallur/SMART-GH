...
public class EncodingManager
{
	...
	public static final String MONOCYCLE = "monocycle";
    ...
    static
    {
		...
		defaultEdgeFlagEncoders.put(MONOCYCLE, MonocycleFlagEncoder.class.getName());
		defaultEdgeFlagEncoders.put(MOTORCYCLE, MotorcycleFlagEncoder.class.getName());
		defaultEdgeFlagEncoders.put(SCOOTER, ScooterFlagEncoder.class.getName());
    }
