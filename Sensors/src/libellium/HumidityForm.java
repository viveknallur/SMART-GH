 ...
 * 
 */
public class HumidityForm extends JFrame implements ActionListener {
	...
	public HumidityForm(String title) {
		this.setTitle(title);
	...
	public static void main(String[] args) {
		HumidityForm form = new HumidityForm("Humidity Data Submission Form");
